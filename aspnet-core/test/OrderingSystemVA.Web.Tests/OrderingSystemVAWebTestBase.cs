...
{
    public abstract class OrderingSystemVAWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OrderingSystemVAWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OrderingSystemVAWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OrderingSystemVADbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OrderingSystemVADbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OrderingSystemVADbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OrderingSystemVADbContext, Task<T>> func)
        {
            T result;
