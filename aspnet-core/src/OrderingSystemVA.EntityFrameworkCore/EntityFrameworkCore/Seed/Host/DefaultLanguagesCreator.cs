...
namespace OrderingSystemVA.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly OrderingSystemVADbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = OrderingSystemVAConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(OrderingSystemVADbContext context)
        {
            _context = context;
        }
